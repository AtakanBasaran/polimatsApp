    ...
    var body: some View {
        ...
        VStack(spacing: 20) {
            ...
            ZStack(alignment: .center) {
                ...
                VStack(alignment: .leading) {
                    ...
                    HStack {
                        ...
                        ImageHandle(placeHolder: "polimats-black", urlString: Manager.shared.getPhoto(dataPolimats: dataPolimats))
                            .aspectRatio(contentMode: .fill)
                        ...
                        Text(Manager.shared.getDate(dataPolimats: dataPolimats))
            ...
            VStack(alignment: .leading, spacing: 10) {
                ...
                Text(Manager.shared.convertHtmlToPlainText(dataPolimats.excerpt.rendered))
